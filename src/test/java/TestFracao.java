...
public class TestFracao {
    ...
    public void test_valor_soma() {
        assertEquals("5/6", fracao.soma(new Fracao(1, 3)).toString());
    }

    @Test
    public void test_valor_diff() {

        assertEquals("1/6", fracao.diff( new Fracao(1, 3)).toString());
    }
    ...
    public void test_valor_div() {
        ...
        assertEquals("3/2", fracao.div( new Fracao(1, 3)).toString());
    }
    ...
    public void test_valor_mult() {
        ...
        assertEquals("1/6", fracao.mult( new Fracao(1, 3)).toString());
    }

    @Test
    public void test_valor_aparente_falso() {

        assertEquals(false, fracao.aparente());
    }
